...
export default function LearningPointPage({}: Props) {
    ...
    useEffect(() => {
      fetchPaginateData(`/admin/learning-point`);
...
<SearchInput
      ...
      <table className="table w-full mt-3">
        ...
        <tbody>
          ...
          {paginate.data.map((item: LearningPointType, index: number) => (
            <tr
              className="bg-slate-400 w-full text-slate-200 text-center"
            ...
            >
              ...
              <td className="border p-2">
                <div className="flex justify-center gap-8">
                  <button
                    onClick={() =>
                      openDeleteModal("/admin/learning-point/" + item.id)
                    }
                  ...
                  <button
                    onClick={() =>
                      router.push("learning-point/edit/" + item.id)
                    }
