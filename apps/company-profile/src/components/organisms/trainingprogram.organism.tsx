...
export default function TrainingProgramSection({}: Props) {
  return (
    ...
    <section
      className="lg:w-[80%] w-full hidden md:flex h-40 mx-auto rounded-t-[60px] items-center justify-center relative mt-0 "
      style={{
    ...
    <section
      className=" mx-auto rounded-t-[60px] flex md:hidden items-center justify-center mt-20"
      >
