...
export default function HeroNews({ }: Props) {
    ...
    return (
        <div className="min-h-screen w-full pt-32 px-4 md:px-24">
            ...
            <div className="absolute top-0 left-0 right-0 p-4 md:p-10">
                <h3 className="text-white text-2xl md:text-4xl font-bold drop-shadow-md">{data[0].title}</h3>
            ...
            <div className="w-full h-[40vh] border border-slate-400 rounded relative overflow-hidden mt-5">
                ...
                <div className="absolute top-0 left-0 right-0 p-4 md:p-10">
                <h3 className="text-white text-2xl md:text-4xl font-bold drop-shadow-md">{data[1].title}</h3>
            ...
            <div className="w-full h-[40vh] border border-slate-400 rounded relative overflow-hidden mt-5">
                ...
                <div className="absolute top-0 left-0 right-0 p-4 md:p-10">
                <h3 className="text-white text-2xl md:text-4xl font-bold drop-shadow-md">{data[2].title}</h3>
